  ...
  return (
    <>
      ...
      <HomeHeader>
        ...
        <h2 className="dia-especial"><i class="bi bi-heart-fill"></i>  Querida mãe, você é como o Kamehameha do Goku, irradiando amor e força em todas as direções. Seu carinho é tão poderoso quanto o Rasengan do Naruto, e sua dedicação é tão inabalável quanto a busca pelo One Piece. Feliz Dia das Mães!  <i class="bi bi-heart-fill"></i></h2>
